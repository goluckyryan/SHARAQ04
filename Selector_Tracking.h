...
// Wed Feb 25 16:06:16 2015 by ROOT version 5.34/10
// from TTree tree/tree
// found on file: test_run23.root
//////////////////////////////////////////////////////////

#ifndef Selector_Tracking_h
#define Selector_Tracking_h
...
class Selector_Tracking : public TSelector {
public :
   ...
   Selector_Tracking(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Selector_Tracking() { }
   ...
   ClassDef(Selector_Tracking,0);
};

#endif

#ifdef Selector_Tracking_cxx
void Selector_Tracking::Init(TTree *tree)
{
...
Bool_t Selector_Tracking::Notify()
{
...
#endif // #ifdef Selector_Tracking_cxx

...
//#######################################################   
   ...
   TH2F* hX  = new TH2F("hX", "TplaX(R) vs TplaX(L)", 200, -1400, 200, 200, -200, 1400); 
   ...
   TString hQtofTitle;
   hQtofTitle.Form("(%7.1f,%7.1f)", QGate[0]-QGate[1], QGate[0]+QGate[1]);
   TH2F* hQ1tof1g = new TH2F("hQ1tof1g", "Q1 vs (tavg - t1) g:TplaX Q2"+hQtofTitle, 100, -4,  8, 200, 0, 3500);
   TH2F* hQ2tof2g = new TH2F("hQ2tof2g", "Q2 vs (t2 - tavg) g:TplaX Q1"+hQtofTitle, 100, -4,  8, 200, 0, 3500);
   
   TH2F* hQ1tof1gSlew = new TH2F("hQ1tof1gSlew", "Q1 vs (tavg - t1) g:TplaX Slew", 200,   0, 10, 200, 0, 3500);
   TH2F* hQ2tof2gSlew = new TH2F("hQ2tof2gSlew", "Q2 vs (t2 - tavg) g:TplaX Slew", 200,   0, 10, 200, 0, 3500);
   
   Int_t Xdiv = 3, Ydiv = 2;
   TCanvas* cTplaSlew = new TCanvas("cTplaSlew", "Tpla Decay constant", 10, 30, 300*Xdiv, 300*Ydiv);   
...
//##########################################################################   
   for( Int_t eventID = firstEntry; eventID < endEntry; eventID ++){
      ...
      if ( TMath::IsNaN(TplaX1) || TMath::IsNaN(TplaX2) ) continue;

...
//         Double_t a = track->GetA();
      ...
      //printf(" %d | nHitV775:%d, tdiff:%10.5f | nHitSMWDC:%d, FH9X:%10.3f \n", eventID, nHitV775, tdiff, nHitSMWDC, FH9X);
   ...
   TString testTitle;
   testTitle.Form("ProjectX, FH9X = (%10.3f,%10.3f|%10.3f)",
